        ...
        <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
            <div class="wrapper wrapper--w790">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row m-b-55">
                        <div class="name">COMPLAINT BOX :</div>
                            <div class="value">
                                <div class="input-group">
                    ...
                    <div align='center'>
                        <input class="btn btn--radius-2 btn--green" name="submit" type="submit" value="Register">
                        <input class="btn btn--radius-2 btn--red" type="reset" name="reset" value="Cancel">
                    </div>
    </form>
                    </div>
                        </div>
