        ...
        else
        {
         ...
         var regmname = /^[a-zA-Z ]{1,}$/;
          ...
          else
          {
            ...
            // var regrfidno = /^(?=.*[a-zA-Z][0-9]).{15,15}$/;
                    ...
                    <div class="row ">
                        <div class="name">Roll Number</div>
                            <div class="value">
                                <div class="row row-space">
                                    <div class="col-2 ">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="number" name="s_txt_roll" >
                         ...
                         <div class="col-3">
                                ...
                                <input class="input--style-5" type="file" name="fileToUpload" 
                        ...
                        <div class="form-row m-b-55">
                            <div class="name">Name</div>
                                <div class="value">
                                    ...
                                    <div class="col-2_3">
                                        <div class="input-group-desc">
                                            <input class="input--style-3" type="text" name="txt_firstnm" >
                                            <label class="label--desc">First Name</label>
                                        </div>
                                    </div>
                                    <div class="col-2_3">
                                        <div class="input-group-desc">
                                            <input class="input--style-3" type="text" name="txt_middlenm" >
                                            <label class="label--desc">Middle Name</label>
                                        </div>
                                    </div>
                                    <div class="col-2_3">
                                        <div class="input-group-desc">
                                            <input class="input--style-3" type="text" name="txt_lastnm" >
                            ...
                            <div class="name">Address</div>
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="addr" value="" >
                        ...
                        <div class="form-row">
                            <div class="name">Mobile Number</div>
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="number" name="mblno" value="">
                        ...
                        <div class="form-row">
                            <div class="name">Email ID</div>
                                <div class="value">
                                    <div class="input-group">
                                        <input class="input--style-5" type="text" name="email" value="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="password" name="c_pass" >
                            ...
                            <div class="name">Aadhar Number</div>
                                <div class="value">
                                    <div class="row row-refine">
                                        <div class="col-9">
                                            <div class="input-group-desc">
                                                <input class="input--style-5" type="number" name="adhar_no"  >
                            ...
                            <div class="name">Date of Join</div>
                                 <div class="value">
                                    <div class="row row-space">
                                        <div class="col-2_3">
                                            <div class="rs-select2 js-select-simple select--no-search">
                                                <input type="date" name="DOJ" min="<?php echo date('Y-m-d');?>">
                                                <hr>
                                            </div>
                                        </div>
                                    </div>
                          ...
                          <div class="form-row m-b-55">
                            ...
                            <div class="value">
                                <div class="row row-refine">
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="number" name="stud_fee">
                            ...
                            <div class="name">Photo</div>
                             <div class="value" name="photo">
                                <div class="row row-refine">
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="file" name="file" onchange="readURL(this);" >
                                            <label class="label--desc">Upload photo</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row m-b-55">
                            ...
                            <div class="value" name="photo">
                                <div class="row row-refine">
                                    <div class="col-9">
                                        <div class="input-group-desc">
                                            <input class="input--style-5" type="text" name="rfid" >
    ...
    <?php
         ...
         if(isset($_POST['reg']))
            ...
            $target_path= $target_path.basename($_FILES['fileToUpload']['name']);
                ...
                $query="INSERT INTO tbl_registrations(`stud_prn`,`stud_rollno`,`user_name`,`address`,`mbl_no`,`email`,`password`,`city`,`state`,`department`,`class`,`semester`,`dob`,`aadhar_no`,`pin_code`,`joining_date`,`gender`,`stud_fee`,`photo`,`Rfid`,`type`)
                 VALUES('".$prn."','".$roll."','".$Name."','".$add."','".$phn."','".$email."','".$pass."','".$city."','".$state."','".$department."','".$class."','".$semseter."','".$DOB."','".$adharno."','".$pincode."','".$DOJ."','".$gender."','".$studfee."','".$photo."','".$RFID."','student')";
